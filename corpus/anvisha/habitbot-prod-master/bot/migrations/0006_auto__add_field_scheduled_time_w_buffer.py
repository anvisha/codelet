...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scheduled.time_w_buffer'
        db.add_column('bot_scheduled', 'time_w_buffer',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scheduled.time_w_buffer'
        db.delete_column('bot_scheduled', 'time_w_buffer')
