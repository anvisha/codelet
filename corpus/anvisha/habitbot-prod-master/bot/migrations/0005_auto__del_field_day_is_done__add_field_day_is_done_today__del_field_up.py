...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Day.is_done'
        db.delete_column('bot_day', 'is_done')

        # Adding field 'Day.is_done_today'
        db.add_column('bot_day', 'is_done_today',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Update.is_done'
        db.delete_column('bot_update', 'is_done')

        # Adding field 'Update.is_done_today'
        db.add_column('bot_update', 'is_done_today',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Day.is_done'
        db.add_column('bot_day', 'is_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Day.is_done_today'
        db.delete_column('bot_day', 'is_done_today')

        # Adding field 'Update.is_done'
        db.add_column('bot_update', 'is_done',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Update.is_done_today'
        db.delete_column('bot_update', 'is_done_today')
