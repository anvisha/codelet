...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invite.invitecode'
        db.add_column('bot_invite', 'invitecode',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True),
                      keep_default=False)

        # Deleting field 'TieStrength.friend'
        db.delete_column('bot_tiestrength', 'friend')

        # Adding field 'TieStrength.friend_id'
        db.add_column('bot_tiestrength', 'friend_id',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invite.invitecode'
        db.delete_column('bot_invite', 'invitecode')

        # Adding field 'TieStrength.friend'
        db.add_column('bot_tiestrength', 'friend',
                      self.gf('django.db.models.fields.CharField')(default='@katrina_', max_length=30),
                      keep_default=False)

        # Deleting field 'TieStrength.friend_id'
        db.delete_column('bot_tiestrength', 'friend_id')
    ...
    models = {
        ...
        'bot.invite': {
            ...
            'invited': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
