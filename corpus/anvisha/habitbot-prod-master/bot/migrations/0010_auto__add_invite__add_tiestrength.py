...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Invite'
        db.create_table('bot_invite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('partname', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ...
            ('habit', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal('bot', ['Invite'])

        # Adding model 'TieStrength'
        db.create_table('bot_tiestrength', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_part', to=orm['bot.Participant'])),
            ('goal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_goal', to=orm['bot.Goal'])),
            ('friend', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('bot', ['TieStrength'])


    def backwards(self, orm):
        # Deleting model 'Invite'
        db.delete_table('bot_invite')

        # Deleting model 'TieStrength'
        db.delete_table('bot_tiestrength')
    ...
    models = {
        ...
        'bot.tiestrength': {
            ...
            'friend': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
