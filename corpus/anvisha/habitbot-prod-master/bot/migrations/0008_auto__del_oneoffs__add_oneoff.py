...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'OneOffs'
        db.delete_table('bot_oneoffs')

        # Adding model 'OneOff'
        db.create_table('bot_oneoff', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('scheduled_ran', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('tweet_since', self.gf('django.db.models.fields.IntegerField')()),
            ('errata', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal('bot', ['OneOff'])


    def backwards(self, orm):
        # Adding model 'OneOffs'
        db.create_table('bot_oneoffs', (
            ('tweet_since', self.gf('django.db.models.fields.IntegerField')()),
            ('scheduled_ran', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('bot', ['OneOffs'])

        # Deleting model 'OneOff'
        db.delete_table('bot_oneoff')
    ...
    models = {
        ...
        'bot.oneoff': {
            ...
            'errata': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
