...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OneOff.errata'
        db.delete_column('bot_oneoff', 'errata')


    def backwards(self, orm):
        # Adding field 'OneOff.errata'
        db.add_column('bot_oneoff', 'errata',
                      self.gf('django.db.models.fields.CharField')(default='crap', max_length=140),
                      keep_default=False)
