...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goal.punish_dow'
        db.add_column('bot_goal', 'punish_dow',
                      self.gf('django.db.models.fields.CharField')(default='*', max_length=1),
                      keep_default=False)


        # Changing field 'Goal.reward_dow'
        db.alter_column('bot_goal', 'reward_dow', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

    def backwards(self, orm):
        # Deleting field 'Goal.punish_dow'
        db.delete_column('bot_goal', 'punish_dow')


        # Changing field 'Goal.reward_dow'
        db.alter_column('bot_goal', 'reward_dow', self.gf('django.db.models.fields.CharField')(max_length=1))
